...
<form action="">
  ...
  <h4>Sex</h4>
	<div >
		...
		<label for="female">Female: <input type="radio" name="sex" bind:group={sex} value="female" /></label>
		
	</div>

  <h4>Fitness Level</h4>
  <div class="flex items-center">
		<label for="male">Beginner:</label>
    <input type="radio" name="level" bind:group={fitnessLevel} value="beginner">

		<label for="male">Intermediate:</label>
    <input type="radio" name="level"  bind:group={fitnessLevel} value="intermediate">

		<label for="male">Advanced:</label>
