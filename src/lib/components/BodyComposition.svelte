<script lang="ts">
	...
	let { currentWeight, initialBodyFat, desiredGains, pratio } = $UserStore;

	const { endingWeight, endingBodyFatPercent } =
		calculateBodyComposition(pratio, desiredGains, currentWeight, initialBodyFat) as BodyComposition;
...
<section class="w-11/12 m-auto">
	...
	<BodyStatsCard bodyFat={initialBodyFat} bodyWeight={currentWeight} title="Starting Stats" colour="primary" />
